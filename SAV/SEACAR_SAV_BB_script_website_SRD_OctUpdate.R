...
SAV3[CommonIdentifier == "Total_SAV", CommonIdentifier := "Total SAV"]
...
SAV3[, `:=` (analysisunit_halid = ifelse(CommonIdentifier %in% species_reject, NA, 
                                         ifelse(str_detect(CommonIdentifier, "Halophila") & is.na(SpeciesName), "Unidentified\nHalophila", 
...
spp <- c("Total SAV", "Total seagrass", "Halodule wrightii", "Halophila decipiens", "Halophila engelmannii", "Halophila johnsonii", 
         "Halophila spp.", "Ruppia maritima", "Syringodium filiforme", "Thalassia testudinum", "Attached algae", "Drift algae")

spp_common <- c("Total SAV", "Total seagrass", "Halophila spp.", "Johnson's seagrass", "Manatee grass", "Paddle grass", 
...
prcollist <- hcl.colors(n = length(progs), palette = "viridis")
