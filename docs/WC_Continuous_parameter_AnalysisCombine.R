...
out_dir <- here::here("WQ_Continuous/output/by_parameter/Combined")

#List all of the files in the "tables" directory that are KendallTau results
files <- list.files(here::here("WQ_Continuous/output/by_parameter"), pattern="KendallTau", full.names=TRUE)
