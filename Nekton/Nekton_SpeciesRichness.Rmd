...
output:
  ...
  pdf_document:
    ...
    toc_depth: 2
    dev: png
    extra_dependencies: ["float", "booktabs", "wrapfig"]
    keep_md: yes
urlcolor: blue
header-includes:
  - \usepackage{float}
...
This markdown file is designed to be compiled by [Nekton_Plot_Render.R](https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Nekton/Nekton_Plot_Render.R) (https://github.com/FloridaSEACAR/SEACAR_Trend_Analyses/blob/main/Nekton/Nekton_Plot_Render.R).
...
for(ma in nekton_MA_Include){
  ...
  desc <- descriptionTable[ManagedAreaName==ma & IndicatorName=="Nekton", get(descriptionColumn)]
  cat("  \n")
  cat(glue("## {ma}"))
