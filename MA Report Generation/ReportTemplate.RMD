...
# Introduction text for the report
cat(knitr::knit_child('Introduction.Rmd', quiet=TRUE))
...
if(in_continuous){
  ...
  cont_file_list <- list.files("data/", pattern = "Combined_WQ_WC_NUT_cont_", full=TRUE)
  ...
  for (param in cont_params_long){
    ...
    file_name <- str_split(str_subset(cont_file_list, par_reg), "data/")[[1]][2]
